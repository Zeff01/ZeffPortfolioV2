  ...
  return (
    ...
    >
      ...
      <div className="p-3 sm:p-6">
        ...
        <p className="text-gray-300 text-xs sm:text-sm mb-2 sm:mb-4 line-clamp-3">
          {project.description}
        </p>
        ...
        {project.techIcons && (
          <div className="flex flex-wrap gap-1 sm:gap-2 mb-2 sm:mb-4">
            {project.techIcons.map((tech, idx) => (
              <span
                key={idx}
                className="px-2 sm:px-3 py-1 text-xs bg-yellow-300/10 text-yellow-300 rounded-full capitalize"
              >
                {getTechName(tech)}
              </span>
            ))}
        ...
        <Link
          href={projectLink}
          target="_blank"
          className="inline-block px-3 sm:px-4 py-1.5 sm:py-2 text-sm bg-yellow-300 text-black rounded-lg hover:bg-yellow-400 transition-colors"
        >
          View Project
        </Link>
      </div>
...
const Projects: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-blackBackground text-white px-3 sm:px-8 md:px-12 py-16 sm:py-24 overflow-hidden">
      <TransitionEffect />
